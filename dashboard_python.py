    ...
    if not df_cm.empty:
        ...
        with col_a:
            anios_disponibles = sorted(
                df_tend["ANIO"].dropna().unique().tolist())
        ...
        if not df_tend.empty:
            if anio_sel != "TODOS":
                df_tend = df_tend[df_tend["ANIO"] == anio_sel]
            ...
            if mes_ini_num <= mes_fin_num:
                df_tend = df_tend[
                    (df_tend["MES_NUM"] >= mes_ini_num) &
                    (df_tend["MES_NUM"] <= mes_fin_num)
                ]
            else:
