...
st.write("Filas en Supabase:", len(df_correctivos))
st.write("Columnas:", df_correctivos.columns)
st.dataframe(df_correctivos.head())
    ...
    if not df_correctivos_abiertos.empty:
        ...
        st.dataframe(
            ...
            column_config={
                ...
                "DIAS_ABIERTOS": st.column_config.ProgressColumn(
                    "Dias Abierto",
                    min_value=0,
                    max_value=60
                ),
